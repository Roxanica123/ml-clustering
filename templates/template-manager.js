...
export class TemplateManager {
    ...
    async em_template(type) {
        ...
        import (`${window.current_path}/data/model/${type}/${this.page}/embed.js`);
        return `<em_container>${embed_text.embed}</em_container>`;
    }
    async partitional_template(type) {
        const path_kmeans = `${window.current_path}/data/partitional/${type}/${this.page}/kmeans/`;
        const path_plus = `${window.current_path}/data/partitional/${type}/${this.page}/kmeans++/`;
    ...
    async hierarchial_template(type) {
        const path = `${window.current_path}/data/hierarchial/${type}/${this.page}/`;
